...
//come back to this function: does it just downheap/upheap once, or fix the whole heap?
...
//adding something to the heap- value is the thing to be added
...
//emptying the full priority queue, working function:
